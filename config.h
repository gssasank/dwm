...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=11", "Font Awesome 5 Brands:size=11", "JoyPixels:pixelsize=11" }; // "JetBrainsMono Nerd Font:size=11", 
static const char dmenufont[]       = "MesloLGS NF:size=11";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#e07f00"; // initial value #005577
...
#include "shiftview.c"
// this one is for the vendor specific keybindings RAZER FTWWWWWW
